...
class VideoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $video1 = Video::create([
            ...
            'disk' => 'test',
            'video_path' => 'test', // will not be used the path is deleted after the video is processed
        ...
        $video7 = Video::create([
            'user_id' => User::where('name', 'Baaed')->first()->id,
            'title' => 'وظف أفضل المستقلين الموجودين في الوطن العربي عن بعد',
            'disk' => 'test',
            'video_path' => 'test',
            'image_path' => 'test/baaed/baaed.png',
            'hours' => '0',
            'minutes' => '0',
            'seconds' => '10',
            'quality' => '240',
